package com.jannesoon.enhancedarmanents.client.gui;

import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

import com.jannesoon.enhancedarmanents.EnhancedArmanents;
...
public class GuiAbilitySelection extends GuiScreen
{
	    		...
	    		if (stack.getItem() instanceof ItemSword || stack.getItem() instanceof ItemAxe || stack.getItem() instanceof ItemHoe || stack.getItem() instanceof ItemBow)
		    	{
		    		...
		    		if (nbt != null)
		    		{
		    			...
		    			for (int i = 0; i < weaponAbilities.length; i++)
		    			{
			    			...
			    			{
		    					weaponAbilities[i] = new GuiButton(i, width / 2 - 215, 100 + (i * 21), 100, 20, I18n.format("enhancedarmanents.ability." + Ability.WEAPONS.get(i).getName()) + " (" + Ability.WEAPONS.get(i).getTier() + ")");
		    					j++;
			    			}
		    				else
			    				weaponAbilities[i] = new GuiButton(i, width / 2 - 100, 100 + ((i - j) * 21), 105, 20, I18n.format("enhancedarmanents.ability." + Ability.WEAPONS.get(i).getName()) + " (" + Ability.WEAPONS.get(i).getTier() + ")");
		    	...
		    	else if (stack.getItem() instanceof ItemArmor)
		    	{
		    		...
		    		if (nbt != null)
		    		{
		    			...
		    			for (int i = 0; i < armorAbilities.length; i++)
		    			{
			    			...
			    			{
		    					armorAbilities[i] = new GuiButton(i, width / 2 - 215, 100 + (i * 21), 100, 20, I18n.format("enhancedarmanents.ability." + Ability.ARMOR.get(i).getName()) + " (" + Ability.ARMOR.get(i).getTier() + ")");
		    					j++;
			    			}
		    				else
		    					armorAbilities[i] = new GuiButton(i, width / 2 - 100, 100 + ((i - j) * 21), 105, 20, I18n.format("enhancedarmanents.ability." + Ability.ARMOR.get(i).getName()) + " (" + Ability.ARMOR.get(i).getTier() + ")");
					...
					if (Experience.getAbilityTokens(nbt) > 0)
					{
						if (stack.getItem() instanceof ItemSword || stack.getItem() instanceof ItemAxe || stack.getItem() instanceof ItemHoe || stack.getItem() instanceof ItemBow)
						{
							for (int i = 0; i < weaponAbilities.length; i++)
							{
								...
								{
									EnhancedArmanents.network.sendToServer(new PacketGuiAbility(i));
								}
							}
						}
						else if (stack.getItem() instanceof ItemArmor)
	...
	private void drawStrings(ItemStack stack, ArrayList<Ability> abilities, NBTTagCompound nbt)
	{
		...
		drawString(fontRenderer, I18n.format("enhancedarmanents.misc.rarity") + ": ", width / 2 - 50, 40, 0xFFFFFF);
		drawString(fontRenderer, I18n.format("enhancedarmanents.rarity." + rarity.getName()), width / 2 - 15, 40, rarity.getHex());
		drawCenteredString(fontRenderer, I18n.format("enhancedarmanents.misc.abilities"), width / 3, 80, 0xFFFFFF);
		drawCenteredString(fontRenderer, I18n.format("enhancedarmanents.misc.abilities.tokens") + ": " + Experience.getAbilityTokens(nbt), width / 2 - 112, 230, 0xFFFFFF);
		drawCenteredString(fontRenderer, I18n.format("enhancedarmanents.misc.abilities.purchased"), width / 2 + 112, 100, 0xFFFFFF);
		drawCenteredString(fontRenderer, I18n.format("enhancedarmanents.ability.type.active"), width / 2 + 75, 120, 0xFFFFFF);
		drawCenteredString(fontRenderer, I18n.format("enhancedarmanents.ability.type.passive"), width / 2 + 150, 120, 0xFFFFFF);
		
		if (Experience.getLevel(nbt) == Config.maxLevel)
		{
			drawString(fontRenderer, I18n.format("enhancedarmanents.misc.level") + ": " + Experience.getLevel(nbt) + TextFormatting.DARK_RED +" (" + I18n.format("enhancedarmanents.misc.max") + ")", width / 2 - 50, 50, 0xFFFFFF);
			drawString(fontRenderer, I18n.format("enhancedarmanents.misc.experience") + ": " + Experience.getExperience(nbt), width / 2 - 50, 60, 0xFFFFFF);
		}
		else
		{
			drawString(fontRenderer, I18n.format("enhancedarmanents.misc.level") + ": " + Experience.getLevel(nbt), width / 2 - 50, 50, 0xFFFFFF);
			drawString(fontRenderer, I18n.format("enhancedarmanents.misc.experience") + ": " + Experience.getExperience(nbt) + " / " + Experience.getMaxLevelExp(Experience.getLevel(nbt)), width / 2 - 50, 60, 0xFFFFFF);
		}
	...
	private void drawTooltips(GuiButton[] buttons, ArrayList<Ability> abilities, int mouseX, int mouseY)
	{
		...
		for (int i = 0; i < buttons.length; i++)
		{
			...
			if (checker.checkHover(mouseX, mouseY))
			{
				...
				list.add(abilities.get(i).getColor() + I18n.format("enhancedarmanents.ability." + abilities.get(i).getName()) + " (" + abilities.get(i).getTypeName() + ")");
				list.add("");
				list.add(I18n.format("enhancedarmanents.abilities.info." + abilities.get(i).getName()));
				list.add("");
				if (stack.getItem() instanceof ItemSword ||stack.getItem() instanceof ItemAxe || stack.getItem() instanceof ItemHoe || stack.getItem() instanceof ItemBow)
				{
						if (i == 0)//FIRE
						{
							...
							if (!(Ability.FIRE.hasAbility(nbt)))
							{
								...
								{
								list.add(I18n.format("enhancedarmanents.abilities.info.chance")+": %0"+ TextFormatting.GREEN + " + %" + c);
								list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": 0 " + I18n.format("enhancedarmanents.abilities.info.seconds")+ TextFormatting.GREEN + " +" + nextlevelduration);
								}
							}
							else
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": " + currentduration + " " + I18n.format("enhancedarmanents.abilities.info.seconds") + TextFormatting.GREEN + " + " + (nextlevelduration-currentduration));
								}
								else
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": " + currentduration +" "+ I18n.format("enhancedarmanents.abilities.info.seconds"));
									if(!(Ability.FIRE.canUpgradeLevel(nbt)))
										list.add(TextFormatting.RED + I18n.format("enhancedarmanents.misc.max")+" " + I18n.format("enhancedarmanents.misc.level"));
								}
							}
						}
						if (i == 1)//FROST
						...
						if (i == 3)//INNATE
						{
							...
							if (!(Ability.INNATE.hasAbility(nbt)))
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance")+": %0"+ TextFormatting.GREEN + " + %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": 0 " + I18n.format("enhancedarmanents.abilities.info.seconds")+ TextFormatting.GREEN + " +" + nextlevelduration);
									list.add(I18n.format("enhancedarmanents.abilities.info.bleedingspeed")+": 0 "+ TextFormatting.GREEN + "+" + nextlevelbleedingspeed);
								}
							}
							else
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": " + currentduration + " " + I18n.format("enhancedarmanents.abilities.info.seconds") + TextFormatting.GREEN + " + " + (nextlevelduration-currentduration));
									list.add(I18n.format("enhancedarmanents.abilities.info.bleedingspeed")+": "+ currentbleedingspeed + " " + TextFormatting.GREEN + "+" + (nextlevelbleedingspeed-currentbleedingspeed));
								}
								else
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": " + currentduration +" "+ I18n.format("enhancedarmanents.abilities.info.seconds"));
									list.add(I18n.format("enhancedarmanents.abilities.info.bleedingspeed")+": " + currentbleedingspeed);
						...
						if (i == 4)//BOMBASTIC
						{
							...
							if (!(Ability.BOMBASTIC.hasAbility(nbt)))
							{
								...
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance")+": %0"+ TextFormatting.GREEN + " + %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.explosionintensity")+": 0 "+ TextFormatting.GREEN + "+" + nextlevelexplosionintensity);
								}
							}
							else
							{
								...
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.explosionintensity")+": "+ currentexplosionintensity + " " + TextFormatting.GREEN + "+" + (nextlevelexplosionintensity-currentexplosionintensity));
								}
								else
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.explosionintensity")+": "+ currentexplosionintensity);
						...
						if (i == 5)//VOID
						{
							...
							if (!(Ability.VOID.hasAbility(nbt)))
							{
								...
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance")+": %0"+ TextFormatting.GREEN + " + %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.damagepercentage")+": %0"+ TextFormatting.GREEN + " + %" + nextleveldamage);
								}
							}
							else
							{
								...
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.damagepercentage")+": %"+ currentdamage + " " + TextFormatting.GREEN + "+ %" + (nextleveldamage-currentdamage));
								}
								else
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance") + ": %" + c);
									list.add(I18n.format("enhancedarmanents.abilities.info.damagepercentage")+": %"+ currentdamage);
						...
						if (i == 6)//ILLUMINATION
						{
							if (!(Ability.ILLUMINATION.hasAbility(nbt)))
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": 0 " + I18n.format("enhancedarmanents.abilities.info.seconds")+ TextFormatting.GREEN + " +" + 6.0);
								}
							}
							else
							{
									list.add(I18n.format("enhancedarmanents.abilities.info.duration") + ": " + 6.0 + " " + I18n.format("enhancedarmanents.abilities.info.seconds"));
							}
						...
						if (i == 7)//ETHEREAL
						{
							...
							if (!(Ability.ETHEREAL.hasAbility(nbt)))
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.durability")+": 0" + TextFormatting.GREEN + " +" + 3.0 + " " );
								}
							}
							else
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.durability")+": "+ currentrepair + " " + TextFormatting.GREEN + "+ " + (nextlevelrepair-currentrepair));
								}
								else
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.durability")+": "+ currentrepair);
						...
						if (i == 8)//BLOODTHIRST
						{
							...
							if (!(Ability.BLOODTHIRST.hasAbility(nbt)))
							{
								if (buttons[i].enabled)
								{
								list.add(I18n.format("enhancedarmanents.abilities.info.damagepercentage")+": %0"+ TextFormatting.GREEN + " + %" + nextlevelpercentage);
								}
							}
							else
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.damagepercentage")+": %"+ currentpercentage + " " + TextFormatting.GREEN + "+ %" + (nextlevelpercentage-currentpercentage));
								}
								else
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.damagepercentage")+": %"+ currentpercentage);
				...
				{		
						...
						if (i == 4)//BEASTIAL
						{
							if (!(Ability.BEASTIAL.hasAbility(nbt)))
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.duration")+": 0 " + I18n.format("enhancedarmanents.abilities.info.seconds")+ TextFormatting.GREEN + " +" + 7.0);
								}
							}
							else
							{
									list.add(I18n.format("enhancedarmanents.abilities.info.duration") + ": " + 7.0 + " " + I18n.format("enhancedarmanents.abilities.info.seconds"));
							}
						...
						if (i == 5)//REMEDIAL
						{
							...
							if (!(Ability.REMEDIAL.hasAbility(nbt)))
							{
								...
								{
									heal=1f;
									list.add(I18n.format("enhancedarmanents.abilities.info.heal_amount") + ": 0 " + TextFormatting.GREEN + "+" + heal);
								}
							}
							else
							{
								if (buttons[i].enabled)
									list.add(I18n.format("enhancedarmanents.abilities.info.heal_amount") +": "+ heal + TextFormatting.GREEN + " +" + 1.0);
								else
									list.add(I18n.format("enhancedarmanents.abilities.info.heal_amount") +": "+ heal);
							}
						...
						if (i == 6)//HARDENED
						{
							...
							if (!(Ability.HARDENED.hasAbility(nbt)))
							{
								if (buttons[i].enabled)
								{
									list.add(I18n.format("enhancedarmanents.abilities.info.chance")+": %0"+ TextFormatting.GREEN + " + %" + chance);
								}
							}
							else
							{
								list.add(I18n.format("enhancedarmanents.abilities.info.chance")+ ": %" + chance);
							}
