package com.jannesoon.enhancedarmanents.leveling;
...
public enum Ability
{
	...
	{
		if (getLevel(nbt) == 1)
			return I18n.format("enhancedarmanents.ability." + this.toString());
		else if (getLevel(nbt) == 2)
			return I18n.format("enhancedarmanents.ability." + this.toString()) + " II";
		else if (getLevel(nbt) == 3)
			return I18n.format("enhancedarmanents.ability." + this.toString()) + " III";
		else
	...
	{
		return I18n.format("enhancedarmanents.ability.type." + type.toString()); 
	}
